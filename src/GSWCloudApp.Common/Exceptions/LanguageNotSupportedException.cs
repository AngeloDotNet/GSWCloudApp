...
/// <summary>
/// Exception thrown when a requested language is not supported.
/// </summary>
public class LanguageNotSupportedException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LanguageNotSupportedException"/> class with a specified error message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LanguageNotSupportedException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
