...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        var databaseConnection = await MicroservicesExtensions.GetConnectionStringFromNamingAsync(builder.Configuration, "SqlGestDocumenti");
        ...
        builder.Services.ConfigureFluentValidation<CreateDocumentoValidator>();
